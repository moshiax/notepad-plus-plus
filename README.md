...
[![GitHub release](https://img.shields.io/github/release/moshiax/notepad-plus-plus.svg)](../../releases/latest)&nbsp;&nbsp;&nbsp;&nbsp;[![Build Status](https://img.shields.io/github/actions/workflow/status/moshiax/notepad-plus-plus/CI_build.yml)](https://github.com/notepad-plus-plus/notepad-plus-plus/actions/workflows/CI_build.yml)
&nbsp;&nbsp;&nbsp;&nbsp;[![Join the discussions at https://blacklivesmatter.com/](https://notepad-plus-plus.org/assets/images/NppCommunityBadge.svg)](https://blacklivesmatter.com/)
